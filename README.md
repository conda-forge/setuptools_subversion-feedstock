About setuptools_subversion-feedstock
=====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/setuptools_subversion-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1902&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/setuptools_subversion-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `setuptools_subversion` can be installed with `conda`:
...
```
mamba install setuptools_subversion
```

It is possible to list all of the versions of `setuptools_subversion` available on your platform with `conda`:
...
```
mamba search setuptools_subversion --channel conda-forge
```
...
mamba repoquery search setuptools_subversion --channel conda-forge

# List packages depending on `setuptools_subversion`:
mamba repoquery whoneeds setuptools_subversion --channel conda-forge

# List dependencies of `setuptools_subversion`:
mamba repoquery depends setuptools_subversion --channel conda-forge
```
